...
@interface MTStickerMoveView : UIView

/** active sticker view */
+ (void)setActiveEmoticonView:(MTStickerMoveView * __nullable)view;
...
@property (nonatomic, strong) MTStickerItem *item;
@property (nonatomic, readonly) CGFloat scale;
@property (nonatomic, readonly) CGFloat rotation;
@property (nonatomic, readonly) BOOL isActive;


@property (nonatomic, copy, nullable) void(^tapEnded)(MTStickerMoveView *view);
