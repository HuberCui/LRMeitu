...
@implementation MTStickerMoveView

+ (void)setActiveEmoticonView:(MTStickerMoveView *)view
{
    static MTStickerMoveView *activeView = nil;
    /** 停止取消激活 */
...
{
    [MTStickerMoveView cancelPreviousPerformRequestsWithTarget:self];
}
...
- (void)setActiveEmoticonView:(MTStickerMoveView *)view
{
    [MTStickerMoveView setActiveEmoticonView:view];
}

- (instancetype)initWithItem:(MTStickerItem *)item
{
    ...
    if(self){
        ...
        [_deleteButton setImage:[UIImage imageNamed:@"deleteSticker"] forState:UIControlStateNormal];
        ...
        [_circleView setImage:[UIImage imageNamed:@"circleSticker"]];
...
- (void)setItem:(MTStickerItem *)item
{
    _item = item;
